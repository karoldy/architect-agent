...
| # | 问题 | 负责人 | 截止 | 架构影响 |
|---|------|--------|------|----------|
| Q1 | ~~数据存储方案：自建 vs Supabase/Firebase~~ → **已决策：Supabase** | ✅ 已解决 | — | 详见 [ADR-0001](decisions/0001-data-storage-strategy.md) |
...
| 部署拓扑 | `architecture/deployment.md` | ✅ 已完成 |
...
| ADR-0004 — 部署平台选型 | `decisions/0004-deployment-platform-selection.md` | ✅ 已完成 |
...
| `architecture/deployment.md` | 部署拓扑文档，包含 Vercel（Web 前端）、Render（Go API）、Supabase（PostgreSQL + Auth + Storage）的平台选型、Mermaid 部署图、CI/CD 流水线、环境策略、成本预估 |
| `decisions/0004-deployment-platform-selection.md` | ADR：部署平台选型 — Vercel/Render/Supabase 的对比分析与决策记录 |
